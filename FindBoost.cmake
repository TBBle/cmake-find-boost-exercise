...
#======================
# Systematically build up the Boost ABI tag for the 'versioned' layout
...
#  -x86     Architecture and address model tag, new in 1.66.0
#           First character is the architecture, then word-size, either 32 or 64
if(NOT Boost_VERSION VERSION_LESS 106600)
  if(NOT ${_boost_RELEASE_ABI_TAG} STREQUAL "-")
    string(APPEND _boost_RELEASE_ABI_TAG "-")
  endif()
  if(NOT ${_boost_DEBUG_ABI_TAG} STREQUAL "-")
    string(APPEND _boost_DEBUG_ABI_TAG "-")
  endif()
  # This needs to be kept in-sync with the section of CMakePlatformId.h.in
  # inside 'defined(_WIN32) && defined(_MSC_VER)'
  if(${CMAKE_CXX_COMPILER_ARCHITECTURE_ID} STREQUAL "IA64")
    string(APPEND _boost_RELEASE_ABI_TAG "i")
    string(APPEND _boost_DEBUG_ABI_TAG "i")
  elseif(${CMAKE_CXX_COMPILER_ARCHITECTURE_ID} STREQUAL "X86"
            OR ${CMAKE_CXX_COMPILER_ARCHITECTURE_ID} STREQUAL "x64")
    string(APPEND _boost_RELEASE_ABI_TAG "x")
    string(APPEND _boost_DEBUG_ABI_TAG "x")
  elseif(${CMAKE_CXX_COMPILER_ARCHITECTURE_ID} MATCHES "^ARM")
    string(APPEND _boost_RELEASE_ABI_TAG "a")
    string(APPEND _boost_DEBUG_ABI_TAG "a")
  elseif(${CMAKE_CXX_COMPILER_ARCHITECTURE_ID} STREQUAL "MIPS")
    string(APPEND _boost_RELEASE_ABI_TAG "m")
    string(APPEND _boost_DEBUG_ABI_TAG "m")
  endif()

  if(CMAKE_SIZEOF_VOID_P EQUAL 8)
    string(APPEND _boost_RELEASE_ABI_TAG "64")
    string(APPEND _boost_DEBUG_ABI_TAG "64")
  else()
    string(APPEND _boost_RELEASE_ABI_TAG "32")
    string(APPEND _boost_DEBUG_ABI_TAG "32")
  endif()
endif()
